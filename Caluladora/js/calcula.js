...
function binario (){
    pantalla.innerHTML=(Number(x).toString(2));
}

function octal (){
    pantalla.innerHTML=(Number(x).toString(8));
}

function hexa (){
    pantalla.innerHTML=(Number(x).toString(16).toUpperCase());
    x.toUpperCase();
}